...
<module external.linked.project.id=":react-native-community_async-storage" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../../android/app" external.system.id="GRADLE" external.system.module.group="HelloWorld" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
